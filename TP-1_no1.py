...
if nombre_etiquette_blanche > 0 and nombre_etiquette_grise > 0:
  ...
  print("Vous ne pouvez pas entrée de nombre négatif. Le programme va maintenant terminer.")
  
# Fin
input("Merci d'avoi utiliser le calculateur de prix!\nTapez sur entré pour quitté")
